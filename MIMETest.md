...
1. 在Postman中新建一个请求
2. 设置请求方法为 **GET**
3. 输入URL: `http://localhost:8022/index.html`
4. 点击 **Send** 按钮
...
**步骤：**
1. 新建GET请求
2. URL: `http://localhost:8022/style.css`
3. 发送请求
...
**步骤：**
1. 新建GET请求
2. URL: `http://localhost:8022/data.json`
3. 发送请求
...
**步骤：**
1. 新建GET请求
2. URL: `http://localhost:8022/sample.txt`
3. 发送请求
...
**步骤：**
1. 新建GET请求
2. URL: `http://localhost:8022/test.png`
3. 发送请求
